...
import com.example.navigationwithviewmodel.databinding.FragmentCalculateBinding
...
class CalculateFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        var binding : FragmentCalculateBinding = DataBindingUtil.inflate(inflater,R.layout.fragment_calculate,container,false)
        binding.model = viewModel //ViewModelProvider(this)[MyViewModel::class.java]
